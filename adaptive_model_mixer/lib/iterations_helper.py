...
def initialise_parser():
    ...
    parser.add_argument('--lmtd-eps', type=float, default=0.0001, help='Max absolute lmtd error. DEFAULT=0.0001')
    parser.add_argument('--bal-eps', type=float, default=0.0001, help='Max absolute error for balancing bilinearities. DEFAULT=0.0001')
    parser.add_argument('--area-eps', type=float, default=0.0001, help='Max absolute error for area bilinearities. DEFAULT=0.0001')
    parser.add_argument('--beta-eps', type=float, default=0.0001, help='Max absolute error for area betas. DEFAULT=0.0001')
    parser.add_argument('-e', '--all-error', type=float, default=0.0001, help='Max absolute error for all approximations. DEFAULT=0.0001')
